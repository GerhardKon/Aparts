...
const WELCOME = {
    role: "assistant",
    content:
        "Здравствуйте! Я Александр — ваш онлайн-консьерж 24/7 в Kurdyukov. Расскажу про студии, локацию и услуги. Свободные даты и точные цены смотрите в модуле бронирования Bnovo на странице — а я помогу с остальным. Чем могу быть полезен?",
};
