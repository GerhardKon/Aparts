...
const BRANCHES = [
    { id: 1, name: "Гончарная, 10", address: "ул. Гончарная, 10", x: 38, y: 52 },
    { id: 2, name: "Гончарная, 12", address: "ул. Гончарная, 12", x: 42, y: 50 },
    { id: 3, name: "Гончарная, 14", address: "ул. Гончарная, 14", x: 46, y: 48 },
    {
        id: 4,
        name: "4-я Советская, 12",
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-14">
                    ...
                    <div className="md:col-span-6 md:pt-12">
                        <p className="text-white/70 leading-relaxed font-light">
                            Пять филиалов на Гончарной улице и 4-й Советской —
                            квартал, где Невский встречается с Лиговским. Утром —
                            кофе у Московского вокзала, вечером — спектакль в
                            Александринке, и пять минут пешком до дома.
                        </p>
                    </div>
                </div>
