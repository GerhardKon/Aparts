...
— Удобства каждого номера: бесплатный Wi-Fi, мини-кухня (плита, чайник, микроволновка, посуда), стиральная машина, ТВ/Smart TV, ежедневная уборка, средства гигиены (тапочки, шампунь, зубная щётка), завтрак в постель по запросу.
— Цена от 1 800 ₽/ночь.
